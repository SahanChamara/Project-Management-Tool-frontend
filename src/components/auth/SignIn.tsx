                ...
                <div className="w-full lg:w-1/2 p-4 sm:p-8 md:p-10">
                    <Tabs defaultValue="login" className="w-full" onValueChange={setActiveTab}>
                        ...
                        <div className='grid w-full grid-cols-1 mb-6 '>
                            <Button>
                                <Link to="/sign-up">
                                    You Don't Have an Account <span className='text-light underline'>Sign Up</span>
                                </Link>
                            </Button>
                        </div>
                        ...
                        <TabsContent value="login">
                            <form className="space-y-6">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <Button onClick={handleClick} variant="outline" type="button" className="flex items-center justify-center gap-2">
